        ...
        return(
            <div className='sub-landing-pgs'>
                    ...
                    <div className='about-info'>
                        <img className='picture-of-myself' src='/myself.jpeg' alt='Picture of Samantha'></img>
                    ...
                    <div className='skill-set'>
                        ...
                        <img className='picture-of-code-icon' src='/code-icon.png' alt='Picture of Code Icon'></img>
                    </div>
                    <Copyright/>
            </div>
        )
